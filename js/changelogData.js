...
const changelogData = [
  {
    version: "2.7",
    date: "2025-10-17",
    title: "Deck Builder & Export System",
    isOpen: true,
    changes: [
      {
        title: "Deck Building & Export Features",
        items: [
          "**NEW: Right-Side Deck Builder:**",
          "ADDED: Right-side deck drawer matching left sidebar styling and behavior.",
          "ADDED: Positioned inside gallery area - reduces card grid by ~2 columns when open.",
          "ADDED: Collapsible toggle with yellow arrow matching left sidebar (saves state).",
          "ADDED: Smooth expand/collapse animations with rescaling gallery content.",
          "**Interactive Card Addition:**",
          "ADDED: Yellow + button appears at bottom-center of cards on hover.",
          "ADDED: Drag-and-drop functionality - drag any card thumbnail into deck builder.",
          "ADDED: Click-to-add functionality with visual feedback animation.",
          "ADDED: Automatic card detection from gallery (works with .thumbnail elements).",
          "**Deck Management:**",
          "ADDED: Quantity selectors for each card (1-4 copies per card maximum).",
          "ADDED: Deck naming input field for custom export filenames.",
          "ADDED: Remove individual cards or clear entire deck (with confirmation).",
          "ADDED: Auto-sorting by card type (Pokémon → Trainer → Energy).",
          "**Color-Coded Validation System:**",
          "ADDED: 🔴 Red (< 40 or > 60 cards): Export blocked, error message shown.",
          "ADDED: 🟠 Orange (40-59 cards): Export allowed, warning message shown.",
          "ADDED: 🟢 Green (60 cards): Standard deck size, success message shown.",
          "ADDED: Real-time card count display with color transitions.",
          "**Export System:**",
          "ADDED: Standard CSV export (QTY,Name,Type,URL format) - fully functional.",
          "ADDED: Automatic filename sanitization based on deck name.",
          "ADDED: Export validation prevents invalid deck sizes.",
          "ADDED: Enhanced CSV and MTCG JSON placeholders (grayed out, Coming Soon).",
          "**User Experience:**",
          "ADDED: Toast notifications for all actions (add, remove, clear, export).",
          "ADDED: Drawer state persists in localStorage between sessions.",
          "ADDED: Responsive design - drawer moves to top on mobile.",
          "ADDED: Smooth animations and visual feedback throughout.",
          "**Technical Implementation:**",
          "ADDED: Modular `js/deck-exporter.js` following project architecture.",
          "ADDED: Theme-matching `assets/css/deck-exporter.css` styling.",
          "ADDED: Integration with existing gallery mutation observers.",
          "FIXED: Proper card data extraction from `.thumbnail` elements.",
          "FIXED: Drag-and-drop data transfer using text/plain for compatibility.",
        ],
      },
      {
        title: "Documentation & Notes",
        items: [
          "ADDED: CSV format test results documented in `CSV_FORMAT_TEST_RESULTS.md`.",
          "ADDED: WebP migration planning documents for future implementation.",
          "ADDED: Test format examples (Standard CSV, Enhanced CSV, MTCG JSON).",
          "ADDED: Comprehensive deck builder guide in `DECK_EXPORTER_GUIDE.md`.",
          "NOTED: Enhanced CSV reserved for post-WebP migration.",
          "NOTED: MTCG JSON reserved for embedded images (experimental).",
        ],
      },
    ],
  },
